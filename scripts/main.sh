...
# внимание на название папки ->django_settings.wsgi:application
...
sudo nano /etc/nginx/sites-available/77.240.38.106-http.conf 
...
server_name localhost 127.0.0.1 77.240.38.106;  
...
sudo ln -s /etc/nginx/sites-available/77.240.38.106-http.conf /etc/nginx/sites-enabled/77.240.38.106-http.conf
#sudo ln -s /etc/nginx/sites-available/ilusa.kz-http.conf /etc/nginx/sites-enabled/ilusa.kz-http.conf
